...
from apps.galeria.views import index, novo_veiculo,imagem,add_imagem,buscar,deletar_veiculo, contato, deletar_imagem, editar_veiculo
...
urlpatterns = [
    ...
    path('editar/<int:veiculo_id>', editar_veiculo, name='editar_veiculo')
]